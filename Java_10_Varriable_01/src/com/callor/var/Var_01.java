package com.callor.var; // Var_01.java 파일이 src/com/callor/var 폴더에 저장되어 있다라는 표식 

public class Var_01 { // class 선언문, class prototype
	public static void main(String[] args) { // 여기에서 부터 실제 명령문 코드가 작성되는 곳
		 ...
		 * 
		 * 정수형 변수 num1을 선언하고 정수 255 값으로
		 * 			  초기화 하라
		 * 정수형 변수 num2를 선언하고 정수 88 값으로
		 * 			  초기화 하라
		 */
		int num1 = 255;
		int num2 = 88;
		...
		int intTelNum = 1012341234;
		int intStAge = 33;
		
		System.out.println(intTelNum + intStAge);
	}
}
