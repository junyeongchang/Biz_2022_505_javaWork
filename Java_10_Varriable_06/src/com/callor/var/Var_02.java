...
public class Var_02 {
	...
	public static void main(String[] args) {
		...
		/*
		 * boolean type 변수선언하고 intNum1 과 intNum2의 값을 비교( >= )하여 나타는 결과 (true 또는 false)를
		 * 변수에 저장
		 */
		 ...
		 * 3. 최종적으로 비교 연산 결과를 bEven 변수에 저장이 연산식의 최종결과가 담기는 bEven의 값은
		 * intNu1 이 짝수이면 true, 아니면 false
		 */
		boolean bEven = (intNum1 % 2) == 0;
		
		/*
		 * intNum1에 저장된 값이 3의 배수인가?
		 * drainge3 에 담긴 값이 true이면 당연히 3의 배수이다.
