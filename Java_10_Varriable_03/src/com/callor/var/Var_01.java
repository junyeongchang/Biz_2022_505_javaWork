...
public class Var_01 {
	...
	public static void main(String[] args) {
		 ...
		 * 반드시 다른 키워드와 조합으로 사용되는 경우가 많다.
		 */
		
		/*
		 * 명령문의 조합
		 * 명령문은 키워드1 키워드2 키워드3 처럼 빈칸으로 키워드를 구분하거나 
		 * 키워드1.키워드2.키워드3 처럼 Dot(.)으로 구분하여 하나의 명령문(statement)를 구현(명령문을 문법에 맞게 완성)한다.
		 * 
		 ...
		 * 등등 사용법이 다양한다.
		 * 
		 * Dot(.)로 조합된 키워드는 사용하는 경우의 수가 제한적인다.
		 * System.out.println()
		 * PrintWriter.println()
		...
		// method에 다라 args 가 있거나 없거나 상관없이 작동 되기도 하고 없으면 문법 오류를 발생하기도 한다.
		// method 에 첨가되는 args는 method 코드가 만들어질때 정해지는 것으로 특별한 규칙이 없다.
