...
public class Execv6A {
	public static void main(String[] args) {
		 ...
		 * i변수를 사용하여 횟수를 구분하면 홀수일때, 짝수일때 상관없이
		 * i변수값은 변화를 하기 때문에 문제가 발생한다.
		 * 
		 * 짝수를 출력할때만다 출력한 횟수를 저장할 변수가 필요하다
		 * 별도로 짝수를 출력할때 만다 출력한 회수를 저장할 변수를 
